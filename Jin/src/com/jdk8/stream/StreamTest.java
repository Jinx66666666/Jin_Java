...
public class StreamTest {
     ...
     */
    @Test
    public void creatSteam() {
//      1、通过 java.util.Collection.stream() 方法用集合创建流
//        stream和parallelStream的简单区分： stream是顺序流，由主线程按顺序对流执行操作，而parallelStream是并行流，
//        内部以多线程并行执行的方式对流进行操作，但前提是流中的数据处理没有顺序要求。例如筛选集合中的奇数，两者的处理不同之处：
...
//        3、使用Stream的静态方法：of()、iterate()、generate()
     ...
     */
    @Test
    public void forEachAndFindAndMatch() {
...
//        案例二： 筛选员工中工资高于8000的人，并形成新的集合。 形成新集合依赖collect（收集），后文有详细介绍。
    ...
    public void maxAndCount() {
        ...
        List<Integer> asList = Arrays.asList(7, 6, 9, 4, 11, 6);

        // 自然排序
        Optional<Integer> integer = asList.stream().max(Integer::compareTo);
        // 自定义排序
        Optional<Integer> max2 = asList.stream().max(new Comparator<Integer>() {
            @Override
            public int compare(Integer o1, Integer o2) {
                return o1.compareTo(o2);
            }
        });
        System.out.println("自然排序的最大值：" + integer.get());
...
//        案例三：获取员工工资最高的人。
        ...
        System.out.println("员工工资最大值：" + person.get().getSalary());
        System.out.println("=============================================================");
...
//        案例三：将两个字符数组合并成一个新的字符数组。
     ...
     */
    @Test
    public void distinctAndLimitAndSkip() {
        String[] arr1 = { "a", "b", "c", "d" };
        String[] arr2 = { "d", "e", "f", "g" };
